...
const directions = { NONE: "NONE", FORWARD: "FORWARD", BACKEWARD: "BACKWARD" };
...
class Carousel extends PureComponent {
  ...
  render() {
    ...
    const setNextSlide = this.setNextSlide;
    ...
    return (
      <ContextProvider
        value={{ currentIndex, nextIndex, prevIndex, setNextSlide }}
      >
        <div className={"carousel__container"} onWheel={this.handleScroll}>
          {wrappedChildren}
        </div>
      </ContextProvider>
    );
